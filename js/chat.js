...
function init(botLogoPath) {
  ...
  template = ` <button class='chat-btn'><img src = "./assets/comment.png" class = "material-icon" ></button>
    ...
    <div class='chat-popup'>
		...
		<div class='chat-header'>
			...
			<button class = "expand-chat-window" ><img src="./assets/open_fullscreen.png" class="material-icon" ></button>
		</div>
  ...
  chatBtn.addEventListener("click", () => {
    ...
    if (chatPopup.style.display == "none" && mobileDevice) {
      ...
      chatInput.focus();
      chatBtn.innerHTML = `<img src = "./assets/close.png" class = "material-icon" >`;
    } else if (mobileDevice) {
      chatPopup.style.display = "none";
      chatBtn.innerHTML = `<img src = "./assets/comment.png" class = "material-icon" >`;
    } else {
      mobileView();
    }
  });
  ...
  expandWindow.addEventListener("click", (e) => {
    ...
    if (
      ...
      '<img src="./assets/open_fullscreen.png" class="material-icon">'
    ) {
      expandWindow.innerHTML = `<img src = "./assets/close_fullscreen.png" class = 'material-icon'>`;
      root.style.setProperty("--chat-window-height", 80 + "%");
      root.style.setProperty("--chat-window-total-width", 85 + "%");
      chatHeader.style.width = "100%";
    } else if (
      expandWindow.innerHTML ==
      '<img src="./assets/close.png" class="material-icon">'
    ) {
      chatPopup.style.display = "none";
      chatBtn.style.display = "block";
    } else {
      expandWindow.innerHTML = `<img src = "./assets/open_fullscreen.png" class = "material-icon" >`;
...
function mobileView() {
  ...
  if (chatPopup.style.display == "none") {
    ...
    expandWindow.innerHTML = `<img src = "./assets/close.png" class = "material-icon" >`;
  }
}
